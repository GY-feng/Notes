...
bool specialMove(Point x)
{
    ...
    if (info == 'A' || info == 'C' || info == 'B' || info == 'D' || info == 'E' || info == 'F' || info == 'G' || info == 'H' || info == 'I' || info == 'J' || info == 'K' || info == 'L' || info == 'M' || info == 'N' || info == 'O' || info == 'P' || info == 'Q' || info == 'R' || info == 'S' || info == 'T' || info == 'U' || info == 'V' || info == 'W' || info == 'X' || info == 'Y' || info == 'Z')
    {
        return true;
    }
    else
